package com.ggb.commonlib.network.manager

import com.google.gson.Gson
import com.google.gson.GsonBuilder
import com.ggb.commonlib.network.config.NetworkConfig
import com.ggb.commonlib.network.interceptor.LoggingInterceptor
import com.ggb.commonlib.network.interceptor.DynamicBaseUrlInterceptor
import com.ggb.commonlib.network.adapter.HtmlEntityStringTypeAdapter
import com.ggb.commonlib.network.ssl.SSLUtils
...
class NetworkManager private constructor() {
    ...
    private fun getDefaultCacheDirectory(): File {
        return try {
            ...
            val helperClass = Class.forName("com.ggb.commonlib.util.StringResourceHelper")
     ...
     */
    fun switchEnvironment(environmentConfig: com.ggb.commonlib.network.config.EnvironmentConfig) {
