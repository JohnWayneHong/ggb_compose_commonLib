...
data class BaseViewState(
     ...
     * 错误信息
     */
    val error: com.ggb.commonlib.network.error.AppException? = null,
     ...
     * 显示错误
     */
    fun showError(error: com.ggb.commonlib.network.error.AppException): BaseViewState {
        return copy(
            isLoading = false,
            error = error,
            showError = true
